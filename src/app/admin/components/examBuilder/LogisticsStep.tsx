...
// import { Clock, Shuffle, Save, ArrowLeft } from 'lucide-react'

// export const LogisticsStep = ({ config, setConfig, onBack, onDeploy }: any) => {
//   // Local state for hours/mins to prevent overstretching and provide a "Clock" feel
//   const [h, setH] = useState(Math.floor(config.timeLimit / 60))
//   const [m, setM] = useState(config.timeLimit % 60)

//   // Sync local H/M back to the main config object
//   useEffect(() => {
//     setConfig((prev: any) => ({ ...prev, timeLimit: h * 60 + m }))
//   }, [h, m, setConfig])

//   return (
//     <div className='max-w-md mx-auto mt-4 space-y-6 animate-in slide-in-from-bottom-4 duration-500'>
...
//           {/* Duration Section - Redesigned for Responsiveness */}
