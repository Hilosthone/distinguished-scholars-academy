      ...
      <div className='max-w-5xl mx-auto px-6 text-center'>
        ...
        <div className='relative mt-12'>
          <AnimatePresence mode='wait'>
            ...
            >
              {/* IMAGE FRAME */}
              <div className='w-28 h-28 mx-auto rounded-full p-[3px] bg-linear-to-br from-[#002EFF] to-[#FCB900] shadow-lg hover:shadow-[0_0_25px_rgba(0,46,255,0.35)] transition overflow-hidden mb-4'>
